...
CREATE
OR
REPLACE FUNCTION update_average_rating()
    RETURNS TRIGGER AS
$$
DECLARE
    avg_rating REAL;
...
CREATE OR
REPLACE TRIGGER update_rating_trigger
    AFTER
INSERT OR
UPDATE OR
DELETE
...
CREATE
OR
REPLACE FUNCTION update_parking_lot()
    RETURNS TRIGGER AS
$$
BEGIN IF NEW.reservation_status = 0 THEN
