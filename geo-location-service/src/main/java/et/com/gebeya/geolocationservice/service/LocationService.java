...
import et.com.gebeya.geolocationservice.dto.*;
...
public class LocationService {
    ...
    public void updateLocation(UpdateLocationDto updateLocationDto) {
        deleteLocation(DeleteLocationDto.builder()
                .id(updateLocationDto.getId())
                .address(updateLocationDto.getExistingAddress())
                .title(updateLocationDto.getExistingTitle()).build());
        addLocation(AddLocationDto.builder()
                .id(updateLocationDto.getId())
                .title(updateLocationDto.getNewTitle())
                .address(updateLocationDto.getNewAddress())
                .longitude(updateLocationDto.getLongitude())
                .latitude(updateLocationDto.getLatitude()).build());
    }
